...
export default class SignaturePad {
  ...
  private _mouseButtonDown: boolean | any;
  private _isEmpty: boolean | any;
  private _lastPoints: Point[] | any; // Stores up to 4 most recent points; used to generate a new curve
  private _data: PointGroup[] | any; // Stores all points in groups (one group per line or dot)
  private _lastVelocity: number | any;
  private _lastWidth: number | any;
